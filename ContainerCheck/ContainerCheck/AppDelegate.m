...
//    HomeViewController *homeview = [[HomeViewController alloc] initWithNibName:@"HomeViewController" bundle:nil];
    ...
    self.window.rootViewController = checkNav;
    
    // 校验是否存在配置文件
    if ([[NSUserDefaults standardUserDefaults] stringForKey:@"WebHost"]==nil)
    {
        [[NSUserDefaults standardUserDefaults] setValue:@"10.199.181.57" forKey:@"IP"];
    }
    NSLog(@"IP地址 = %@", [[NSUserDefaults standardUserDefaults] objectForKey:@"IP"]);
